...
let pconf = document.querySelector('.box-result p')
        ...
        async function predict() {
            // Function for invoking prediction of plant leaf diseases detection
            let img = document.getElementById('image')
        ...
        // here you can see the add event listerner function where the upload button clicked then the function start processing
